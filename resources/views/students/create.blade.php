...
<form class="row g-2 mb-3" method="post" action="{{ route('students.store') }}">  
  @csrf
  <div class="card shadow-sm bg-light">   <!-- yahan color change kiya (pehle green tha, ab light gray hai) -->
    <div class="card-body">
